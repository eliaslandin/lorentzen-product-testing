...
GRANT EXECUTE
ON FUNCTION api.custom_access_token_hook
TO supabase_auth_admin;

GRANT SELECT ON TABLE api.role_user_relations
TO supabase_auth_admin;

CREATE POLICY "Allow supabase_auth_admin to read role user relations"
